...
region = "ap-south-1"
scan_db_table = "benchmark-normalised-bikes"
query_db_table = "benchmark-sta-bikes"
...
print("INSERTED DATA SOURCE IN NORMALISED TABLE")
...
print("INSERTED DATA SOURCE IN SINGLE TABLE")
